...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.startBtn || v.getId() == R.id.quitBtn) {
            if (v.getId() == R.id.quitBtn && saveImpossible) timer.cancel();
            change();
        }
            ...
            if (thirdAnswer.getText().toString().equals("") || thirdAnswer.getText().toString().equals("-")) {
                thirdAnswer.setText("");
        ...
        else if (impossibleAccess) {  // impossible mode switch is activated and user has access
